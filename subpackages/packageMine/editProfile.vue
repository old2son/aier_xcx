<template>
  <view class="edit-profile-container">
      ...
      <view 
        ...
        <view class="edit-user-info-box">
          ...
          <view class="gender">
            ...
            <view class="init-info" @click="showGeneralPopup('gender')">{{ userInfo.gender === 1 ? '男' : '女' }}</view>
          </view>
          <view class="birthday">
            <view class="title">生日</view>
            <view class="init-info" @click="showGeneralPopup('birthday')">{{ userInfo.birthday || '请选择生日' }}</view>
          </view>
          <view class="address">
            <view class="title">地区</view>
            <view class="init-info" @click="showGeneralPopup('area')">{{ userInfo.address || '请选择地区' }}</view>
          </view>
        </view>
    ...
    <van-popup :show="popupShow" position="bottom" custom-style="height: 35%;">
      ...
      <van-field type="text" :value="userName" placeholder="请输入您更改的用户名" @input="userName = $event.detail" />
