<template>
	<view class="online-consultation-container">
		...
		>
			...
			<view v-if="historyMessageList.length > 0 && !historyFolded" class="fold-btn" @click="toggleHistoryFold">
				折叠历史消息
			</view>
		...
		<view class="input-box" v-if="showInputBox">
			<input v-model="selectedQuestions" placeholder="很高兴为您服务，请描述您的问题" @confirm="askQuestion" />
...
import { getOnlineConsultation, scienceUserOnline, scienceUserOnlineHistory } from '@/api';
