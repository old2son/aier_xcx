<template>
	<view class="login-container">
		...
		<view class="login-panel">
			...
			<van-cell-group>
				<van-field clearable type="tel" maxlength="11" :adjust-position="false" placeholder="请输入手机号"
					:left-icon="loginPanelIcon[0].imgUrl" :value="verificationCodeLoginParams.phone"
					@input="updatePhone" />
				<van-field clearable type="number" maxlength="6" :adjust-position="false" placeholder="验证码"
					custom-class="second-field" :left-icon="loginPanelIcon[1].imgUrl"
					:value="verificationCodeLoginParams.code" @input="updateVerCode">
					<van-button slot="button" size="small" type="primary" color="transparent" custom-class="send-btn"
						:disabled="!isPhoneValid || countDown !== 0" @click="getVerificationCode">
			...
			<van-button round color="#32579c" size="large" class="login-btn" custom-style="height: 88rpx"
			...
			<view class="privacy-policy-wrap">
				<view class="policy-point-block">
					<van-checkbox :value="checked" checked-color="#32579c" icon-size="28rpx"
