<template>
  <view class="original-collection-container">
   ...
   <view 
      ...
      <view class="collection-item" v-for="(item,index) in originalList" :key="item.columnId" @click="toSubpackagePage(`packageCategory/hotScience/originalCollectionDetail?collectId=${item.specialId}`)">
