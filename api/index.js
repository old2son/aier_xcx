...
/* ———— 首页页面接口 ———— */
// 顶部 banner 轮播图
export const getScienceHomeTopImage = () =>
	request({
		url: baseUrl + '/api/user/getScienceHomeTopImage'
	});
// 精选推荐
export const getScienceHomeRecommendations = () =>
	request({
		url: baseUrl + '/api/user/getScienceHomeRecommendations'
	});
// 基地动态
export const getScienceHomeBaseDynamics = () =>
	request({
...
// 手机登录
export const scienceMuseumUserLogin = (params) =>
	request({
...
// 获取个人资料
export const getScienceMuseumUserInforMation = () =>
	request({
...
/* 编辑个人资料 */
export const scienceMuseumUserUpdateNickName = (params) =>
	request({
...
// 用户上传头像
export const scienceMuseumUserUploadAvatar = (params) =>
	request({
...
// 查询当天已有需要讲解人数
export const getReservationWeekNumbers = (params) =>
	request({
...
// 查询某一时段已预约人数
export const getReservationTimeSlotNumbers = (params) =>
	request({
...
// 提交个人预约
export const personalReservation = (params) =>
	request({
...
// 活动中心进行中
export const getScienceActivityInProgress = () =>
	request({
		url: baseUrl + '/api/user/getScienceActivityInProgress'
	});
// 活动中心预告
export const getScienceActivityEvents = () =>
	request({
...
// 活动中心个人预约
export const personalActivityReservation = (params) =>
	request({
...
// 活动中心团队预约
export const personalActivityTeamReservation = (params) =>
	request({
		url: baseUrl + '/api/user/personalActivityTeamReservation',
		data: params,
		method: 'POST',
		auth: {
			needLogin: true
...
// {{ 热门科普 }}
// 分类导航icon
export const getInnerPageIcon = (params) =>
	request({
		url: baseUrl + '/api/user/getInnerPageIcon',
		data: params
	});
// 筛选关键词
export const getOrbitopathyYearQuery = (params) =>
	request({
		url: baseUrl + '/api/user/getOrbitopathyYearQuery',
		data: params
	});
// 筛选数据
export const getOrbitopathyQueryReviewVideo = (params) =>
	request({
		url: baseUrl + '/api/user/getOrbitopathyQueryReviewVideo',
		data: params
	});
// 基地原创
export const getScienceOriginal = () =>
	request({
		url: baseUrl + '/api/user/getScienceOriginal'
	});
// 基地原创合集的视频列表的banner
export const getOrbitopathyDoctorTeamBanner = (params) =>
	request({
		url: baseUrl + '/api/user/getOrbitopathyDoctorTeamBanner',
		data: params
	});
// 基地原创合集的视频列表
export const getHotRecommendInpage = (params) =>
	request({
...
// {{ 基地概况 }}
// 基地概况轮播图
export const getScienceOverViewBanner = () =>
	request({
		url: baseUrl + '/api/user/getScienceOverViewBanner'
	});
// 基地概况菜单选项
export const getScienceOverView = () =>
	request({
...
/* ———— 收藏相关接口 ———— */
// 点击收藏
export const scienceAddCollect = (params) =>
	request({
...
// 查询多个文章收藏状态
export const collectListStatus = (params) =>
	request({
...
// 浏览记录
export const scienceHistoryWatch = () =>
	request({
...
// 查询所有奖品
export const getSciencePrizes = () =>
	request({
		url: baseUrl + '/api/user/getSciencePrizes'
	});
// 兑换奖品
export const scienceExchangePrizes = (params) =>
	request({
...
// 查询用户积分收入
export const getMyPointsIncome = () =>
	request({
...
// 查询用户积分支出
export const getMyPointsExpenses = () =>
	request({
...
// 兑换记录
export const scienceMyExchange = () =>
	request({
...
// 签到领积分
export const scienceSignIn = (params) =>
	request({
...
// 查询在线咨询五个问题
export const getOnlineConsultation = () =>
	request({
...
// 在线咨询提问
export const scienceUserOnline = (params) =>
	request({
...
// 查询在线咨询历史记录
export const scienceUserOnlineHistory = () =>
	request({
...
export const getScienceMessageList = () =>
	request({
...
// 查询消息内页
export const getScienceMessageInsidePage = (params) =>
	request({
...
/* ———— 意见反馈相关接口 ———— */
// 查询在意见反馈的题目信息
export const getFeedbackTopic = () =>
	request({
		url: baseUrl + '/api/user/getFeedbackTopic'
	});
// 提交意见反馈
export const scienceFeedback = (params) =>
	request({
