    ...
    <view class="scroll-main">
      <view class="category-nav">
        ...
        <view class="category-nav-box">
          <view
            ...
            :key="item.columnId"
            @click="toSubpackagePage(`packageCategory/hotScience/categoryIconInner?categoryId=${item.columnId}&titleActiveColor=${item.introduce}`)"
          >
            <view class="img-box">
      ...
      <view class="original-list">
        <view 
          ...
          :key="item.columnId"
          @click="toSubpackagePage(`packageCategory/hotScience/originalCollectionDetail?collectId=${item.specialId}`)"
        >
          <view class="img-box">
...
<script>
  ...
  import { 
    getInnerPageIcon,
    getScienceOriginal,
    getSciencePopularRecommendations
  } from '@/api'
  export default {
    data() {
      return {
