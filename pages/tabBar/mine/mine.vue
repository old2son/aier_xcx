    ...
    <view 
      ...
      <view class="header-box">
        ...
        <view class="left-block">
          <!-- 未登录 -->
         <view class="not-logged-in-box" v-if="!hasValidUserInfo" @click="toSubpackagePage('/subpackages/packageLogin/login')">
         ...
         <view class="logged-in-box" v-else>
            ...
            <view class="user-right-part">
              ...
              <view class="sign-in-btn" @click="toSubpackagePage('/subpackages/packageMine/points/index')">
        ...
        <view class="right-block" v-if="hasValidUserInfo">
          <image
            class="edit-icon"
            :src="tabBarData.rightArrowIcon" 
            mode="heightFix"
            @touchstart="toSubpackagePage('/subpackages/packageMine/editProfile')"
          ></image>
        </view>
      </view>
      ...
      <view class="category-box">
        ...
        <view class="category-list">
          <view class="category-item" v-for="(item,index) in tabBarData.categoryList" :key="item.id">
            <view class="img-wrap" :style="{ backgroundImage: `url(${item.imgUrl})` }" @click="toSubpackagePage(item.tourl)"></view>
      ...
      <view class="bottom-category-box">
        <view 
          ...
          v-for="(item,index) in tabBarData.bottomCategoryList" 
          :key="item.id"
