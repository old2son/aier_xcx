...
@font-face {
  font-family: "阿里妈妈灵动体 VF Thin";src: url("//at.alicdn.com/wf/webfont/4vlF4edl5bDm/uLLo6f1127AR.woff2") format("woff2"),
  url("//at.alicdn.com/wf/webfont/4vlF4edl5bDm/ZVxJJ4aiNnW3.woff") format("woff");font-variation-settings: "SRIF" 0.87, "slnt" 12, "wdth" 81.39, "wght" 700;font-display: swap;
}
...
.center-text {
  ...
  z-index: 2;
  text-align: center;
  font-family: "阿里妈妈灵动体 VF Thin";font-variation-settings: "SRIF" 0.87, "slnt" 12, "wdth" 81.39, "wght" 700; /* Chrome 140 以下版本需要 */
